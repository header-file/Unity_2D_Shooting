...
public class UIManager : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        Debug.Log(PanelPosOrigin);

        PlayerPosUI = new Vector3(0.0f, 5.8f, 0.0f);
        SubWeaponPosUI = new Vector3(0.0f, PlayerPosUI.y - 0.3f, 0.0f);
        BackgroundPosUI = new Vector3(0.0f, PlayerPosUI.y + 3.3f, 0.0f);
        PanelPosUI = new Vector3(0.0f, 3.8f, 90.0f);
